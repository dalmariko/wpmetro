...
if ( ! function_exists( 'metro_setup' ) ) :
	...
	function metro_setup() {
		 ...
		 * If you're building a theme based on metro, use a find and replace
		 * to change 'metro' to the name of your theme in all the template files.
		 */
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'metro' ),
		) );
		...
		add_theme_support( 'custom-background', apply_filters( 'metro_custom_background_args', array(
 ...
 */
function metro_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'metro_content_width', 640 );
}
add_action( 'after_setup_theme', 'metro_content_width', 0 );
...
function metro_widgets_init() {
	register_sidebar( array(
		...
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'metro' ),
